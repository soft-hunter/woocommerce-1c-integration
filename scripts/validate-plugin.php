...
class PluginValidator {
    ...
    private function check_file_structure() {
        ...
        $required_files = array(
            'src/woocommerce-1c-integration.php',
            ...
            'src/includes/class-wc1c-logger.php',
            'src/admin/class-wc1c-admin.php',
            'src/exchange/class-wc1c-exchange.php',
            'src/exchange/class-wc1c-auth.php',
            'src/exchange/class-wc1c-xml-parser.php',
            'src/exchange/mappers/class-wc1c-hpos-order-mapper.php',
            'src/uninstall.php',
            'composer.json',
            'README.md',
            'CHANGELOG.md',
